...
const generatorRevenuePortfolioDummy = require('./graph/GeneratorRevenuePortfolioDummy');
const generatorREGOCertificatesDummy = require('./graph/GeneratorREGOCertificatesDummy');
const generatorAssetvsGridDummy = require('./graph/GeneratorAssetvsGridDummy');
const generatorPPAREGOCertificatesDummy = require('./graph/GeneratorPPAREGOCertificatesDummy');
const generatorGenPortfolioDummy = require('./graph/GeneratorGenPortfolioDummy');
const generatorAssetAvailabilityDummy = require('./graph/GeneratorAssetAvailabilityDummy');
const generatorPpaSupplyDummy = require('./graph/GeneratorPPASupplyDummy');
const generatorPpaFinancialsDummy = require('./graph/GeneratorPPAFinancialsDummy');
...
const graphMapping = {
  ...
  'generator-revenue-dummy': generatorRevenueDummy,
  'generator-revenue-portfolio-dummy': generatorRevenuePortfolioDummy,
  'generator-rego-certificates-dummy': generatorREGOCertificatesDummy,
  'generator-asset-grid-dummy':generatorAssetvsGridDummy,
  'generator-ppa-rego-certificates-dummy': generatorPPAREGOCertificatesDummy,
  'generator-gen-portfolio-dummy': generatorGenPortfolioDummy,
  'generator-asset-availability-dummy' : generatorAssetAvailabilityDummy,
  'generator-ppa-supply-dummy' : generatorPpaSupplyDummy,
  'generator-ppa-financials-dummy' : generatorPpaFinancialsDummy,
};
