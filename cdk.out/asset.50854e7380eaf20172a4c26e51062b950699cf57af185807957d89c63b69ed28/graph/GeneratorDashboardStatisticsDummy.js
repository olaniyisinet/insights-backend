...
const populateLastDayData = (statisticsData, tenant) => {
    ...
    statisticsData.gnerationChange = randomIntBetween(1, energyGenerationChange);
    ...
    let revenChange = ds.revenChange;
    statisticsData.revenue = randomFloatBetween(revenueMin, revenueMax);
    statisticsData.revenChange = randomIntBetween(1, revenChange);
