...
const populateLastDayData = (statisticsData, tenant) => {
    ...
    statisticsData.generation = formatNumber(randomFloatBetween(energyGenerationMin, energyGenerationMax));
    ...
    statisticsData.revenue = formatNumber(randomFloatBetween(revenueMin, revenueMax));
    ...
    statisticsData.costSavingChange = -1 * randomIntBetween(1, totalAssetsChange);
    return statisticsData;
}
