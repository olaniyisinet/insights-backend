...
const getGraphData = ({input, user, tenant}) => {
    ...
    let ppaSupplyUnit = ppaKpi.ppaSupplyUnit;
...
const getGraphDataPoints = (input, graphRange, ppaKpi) => {
    let graphData = [];
    let ppaSupplyActualMin = ppaKpi.ppaSupplyActualMin;
    let ppaSupplyActualMax = ppaKpi.ppaSupplyActualMax;
    let ppaSupplyExpectedMin = ppaKpi.ppaSupplyExpectedMin;
    let ppaSupplyExpectedMax = ppaKpi.ppaSupplyExpectedMax;
