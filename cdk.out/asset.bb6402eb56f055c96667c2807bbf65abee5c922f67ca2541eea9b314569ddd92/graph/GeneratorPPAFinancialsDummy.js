...
const getGraphData = ({input, user, tenant}) => {
    ...
    let assetsPPAFinancialUnit = ppaFinancials.assetsPPAFinancialUnit;
    ...
    return {
        ...
        graphDataUnit: assetsPPAFinancialUnit,
        graphData: graphData
    };
};
...
const getGraphDataPoints = (input, graphRange, ppaFinancials) => {
    let graphData = [];
    let assetsPPAFinancialActualMin = ppaFinancials.assetsPPAFinancialActualMin;
    let assetsPPAFinancialActualMax = ppaFinancials.assetsPPAFinancialActualMax;
    let assetsPPAFinancialExpectedMin = ppaFinancials.assetsPPAFinancialExpectedMin;
    let assetsPPAFinancialExpectedMax = ppaFinancials.assetsPPAFinancialExpectedMax;
    if(input.graphOption === 'YESTERDAY' 
        ...
        for (let slot = 0; slot < 24; slot++) {
            ...
            populateRandomDataPoint('Actual', graphData, {
                ...
                minNumber: assetsPPAFinancialActualMin,
                maxNumber: assetsPPAFinancialActualMax,
                isZero: isZeroSlotOne
            });
            populateRandomDataPoint('Expected', graphData, {
                timeSlot: slotOneName,
                multiplicationFactor: 1/48,
                minNumber: assetsPPAFinancialExpectedMin,
                maxNumber: assetsPPAFinancialExpectedMax,
                isZero: isZeroSlotOne
            });
        }
